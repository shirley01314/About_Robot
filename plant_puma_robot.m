...
sys = simsizes(sizes);
x0  = [1 0.5 0.5 1 1 1 1 1 1 1 1 1];
str = [];
ts  = [0 0];
...
%关节角度q和关节角速度dq
q=[q1-pi/2;q2;q3;q4-pi/2;q5;q6];  %6*1矩阵
...
rc1=A1*r1;  %3*3 * 3*1
rc2=A1*a2+A2*r2;
rc3=A1*a2+A2*a3+A3*r3;
rc4=A1*a2+A2*a3+A3*a4+A4*r4;
rc5=A1*a2+A2*a3+A3*a4+A4*a5+A5*r5;
rc6=A1*a2+A2*a3+A3*a4+A4*a5+A5*a6+A6*r6;
